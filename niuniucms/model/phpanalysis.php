...
class PhpAnalysis
{
    ...
    public $addonDicFile = APP_PATH . 'core/dict/words_addons.dic';
    ...
    public $mainDicFile = APP_PATH . 'core/dict/base_dic_full.dic';
    ...
    {
        $this->addonDicFile = APP_PATH . 'core/dict/words_addons.dic';
        $this->mainDicFile  = APP_PATH . 'core/dict/base_dic_full.dic';
    ...
    */
     ...
     */
     ...
     /**
     * 编译词典
     * @parem $sourcefile utf-8编码的文本词典数据文件<参见范例core/dict/not-build/base_dic_full.txt>
