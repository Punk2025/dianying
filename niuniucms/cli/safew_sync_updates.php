<?php
/**
 * SafeW 频道ID同步（自动发现 chat_id）
 *
 * 用法：
 * php /www/wwwroot/sesewu3.eu.cc/niuniucms/cli/safew_sync_updates.php <BOT_TOKEN> [limit] [bot_id]
 */
if (PHP_SAPI !== 'cli') {
    exit("CLI only\n");
}
...
if ($token === '') {
    echo "usage: php cli/safew_sync_updates.php <BOT_TOKEN> [limit]\n";
    exit(1);
}
if (!function_exists('safew_sync_updates')) {
