<?php
/**
 * SafeW 自动推送 worker（推送新入库视频）
 *
 * 用法：
 * php /www/wwwroot/sesewu3.eu.cc/niuniucms/cli/safew_push_worker.php <BOT_TOKEN> <BASE_URL> [limit] [bot_id]
 * 例：
 * php /www/wwwroot/sesewu3.eu.cc/niuniucms/cli/safew_push_worker.php 123:ABC https://sesewu3.eu.cc 10
 */
if (PHP_SAPI !== 'cli') {
    exit("CLI only\n");
}
...
if ($token === '' || $base_url === '') {
    echo "usage: php cli/safew_push_worker.php <BOT_TOKEN> <BASE_URL> [limit]\n";
    exit(1);
}
